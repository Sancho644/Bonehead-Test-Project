...
namespace Components
{
    public class RandomSpawner : MonoBehaviour
    {
        ...
        [SerializeField] private bool _canvasSpawn;
        ...
        private void Start()
        {
            _dropObjects.OnDropCalculated += StarDrop;
        }

        private void StarDrop(GameObject[] items)
        {
            TryStopRoutine();
        ...
        {
            var instance = _canvasSpawn
                ? Instantiate(particles, _targetTransform)
